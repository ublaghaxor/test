...
# Time Succes decompile : 2022-03-29 16:32:10.025048 
...
{M}██╔╝╚██╗  ╚█████╔╝╚█████╔╝██████╔╝███████╗
╚═╝░░╚═╝  ╚════╝░░╚════╝░╚═════╝░╚══========
{U}[{P}>{H}]{P} Au : Acill-Xcode
{II}[{P}>{H}]{P} Wa : +62896-6836-3509 
{M}[{P}>{H}]{P} Fb : facebook.com/Acillxcode12
{O}[{P}•{K}]{P}—————————————————————————————""")
		jalan(google)
	def mani(self):
		self.tampilan_logo()
